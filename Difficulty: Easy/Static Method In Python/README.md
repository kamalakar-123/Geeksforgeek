<h2><a href="https://www.geeksforgeeks.org/problems/static-method-in-python/1?selectedLang=python3">Static Method In Python</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Design a class as described below:</span></p>
<ul>
